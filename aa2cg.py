...
INPUT:
1. AA structure and trajectory
2. mapping file in the following format:
[mapping]
CG_bead_name1 : CG_bead_type1 : indices of atoms belonging to this CG bead
CG_bead_name2 : CG_bead_type2 : indices of atoms belonging to this CG bead
CG_bead_name3 : CG_bead_type3 : indices of atoms belonging to this CG bead
.....
CG_bead_nameN : CG_bead_typeN : indices of atoms belonging to this CG bead

OUTPUT:
1. CG structure, CGed AA trajectory, and initial topology (itp) to be optimised
2. mapping file reformatted for further optimisation step:
[mapping]
CG_bead_index1 : indices of atoms belonging to this CG bead
CG_bead_index2 : indices of atoms belonging to this CG bead
.....
CG_bead_indexN : indices of atoms belonging to this CG bead
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
'''
...
for i in u_cg.atoms:
    mol._atoms[int(i.id)] = Atom(int(i.id), bead_type[str(i.name)], int(i.resid), mol.molname, str(i.name), int(i.resid), 0)
