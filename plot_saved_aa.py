...
if str(options.load).upper()[0] in ['1', 'T', 'Y']:
    try:
        ...
        print '#### AA distributions: ####'
        for b_g in mol.b_dic_opt.keys():
            print b_g, mol._bonds[mol.b_dic_opt[b_g][0]].aa_dist
        for an_g in mol.an_dic_opt.keys():
            print an_g, mol._angles[mol.an_dic_opt[an_g][0]].aa_dist
    except:
...
# getting the distribution for the CG system now...
...
##        if num_frame == 1: aa_hist_x = aa_hist_x + 10
#         if num_frame == 2: aa_hist_x = aa_hist_x - 13
#         if num_frame == 3: aa_hist_x = aa_hist_x - 10
##        if num_frame == 4: aa_hist_x = aa_hist_x + 4
##        if num_frame == 5: aa_hist_x = aa_hist_x + 4
##        if num_frame == 6: aa_hist_x = aa_hist_x + 23
##        if num_frame == 7: aa_hist_x = aa_hist_x + 16
